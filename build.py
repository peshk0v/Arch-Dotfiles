...
os.system("sudo pacman -S cargo npm hyprpaper hyprshot hyprlock wlogout git curl rofi nano brightnessctl pulseaudio waybar fastfetch kitty htop xorg swww nautilus nwg-look obsidian telegram-desktop discord nerd-fonts ttf-ubuntu-font-family ttf-font-awesome")
